...
export class SysUser {
  ...
  @ApiProperty({ description: 'WeChat OpenID', required: false, nullable: true })
  @Index('IDX_sys_user_openid', { unique: true })
  @Column({ length: 64, nullable: true, name: 'openid', comment: 'WeChat OpenID for quick login' })
  openid: string | null;
