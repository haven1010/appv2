...
const PHASE1_ROUTE_PATTERNS = [
  ...
  { method: 'POST', pattern: /^\/base\/\d+\/jobs$/ },
  { method: 'GET', pattern: /^\/base\/\d+\/jobs(?:\?.*)?$/ },
  { method: 'GET', pattern: /^\/base\/jobs(?:\?.*)?$/ },
  { method: 'GET', pattern: /^\/base\/jobs\/\d+(?:\?.*)?$/ },
  { method: 'PATCH', pattern: /^\/base\/jobs\/\d+\/audit(?:\?.*)?$/ },
  ...
  { method: 'GET', pattern: /^\/attendance\/detail\/\d+$/ },
  ...
  { method: 'POST', pattern: /^\/salary\/reports\/backfill$/ },
