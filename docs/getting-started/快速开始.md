...
1. 点击"导入项目"
2. 项目目录选择：`apps/wechat-miniprogram`
3. AppID：
   - 如果有小程序账号，填写你的AppID
...
编辑 `apps/wechat-miniprogram/app.js`，确保 `baseUrl` 正确：
...
2. 或者创建简单的图标文件放在 `apps/wechat-miniprogram/images/` 目录
...
**A**: 
1. 创建图标文件放在 `apps/wechat-miniprogram/images/` 目录
...
**提示**：详细的功能测试步骤请参考 `../testing/测试指南.md`
